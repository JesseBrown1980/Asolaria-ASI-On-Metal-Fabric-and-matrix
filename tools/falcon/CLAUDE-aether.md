# Aether — Asolaria Fabric Node (remote-controlled drive)

## What this is
Aether (A06, serial R9QY205KAKJ) is an Asolaria fabric PROCESSING NODE, currently
USB-connected to acer (a drive here), to go remote/aerial later. acer and the fabrics
REMOTE-CONTROL Aether by files. That is the point.
...
- Aether-omnicoder-persistent.sh: respawn watchdog so the host stays up permanently.
...
acer/liris backend; Aether runs the cheap 8-byte host + receives remote control by files.
